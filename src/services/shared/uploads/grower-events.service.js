...
const GrowerEventService = {
  ...
  async uploadFiles (params, useUploadProgress = null) {
    ...
    return axios.post('shared/uploads/grower-tasks', params, finalConfig)
  },

  async removeFile (data = { attachment_path: '', file_name: '' }) {
    return axios.delete('shared/uploads/grower-task-events/remove', { data })
  },

  async removeFiles (data = { attachment_path: '' }) {
    return axios.delete('shared/uploads/grower-task-events/remove-all', { data })
  }

}

export default GrowerEventService
