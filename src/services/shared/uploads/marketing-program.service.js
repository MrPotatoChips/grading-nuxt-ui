...
const ProgramReceiptService = {
  ...
  async uploadFiles (params, useUploadProgress = null) {
    ...
    return axios.post('shared/uploads/program-documents', params, finalConfig)
  },

  async removeFile (data = { attachment_path: '', file_name: '' }) {
    return axios.delete('shared/uploads/program-documents/remove', { data })
  },

  async removeFiles (data = { attachment_path: '' }) {
    return axios.delete('shared/uploads/program-documents/remove-all', { data })
  }

}

export default ProgramReceiptService
