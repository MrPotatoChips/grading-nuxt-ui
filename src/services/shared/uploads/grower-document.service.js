...
const GrowerDocumentService = {
  ...
  async uploadFiles (params, useUploadProgress = null) {
    ...
    return axios.post('shared/uploads/grower-documents', params, finalConfig)
  },

  async removeFile (data = { attachment_path: '', file_name: '' }) {
    return axios.delete('shared/uploads/grower-documents/remove', { data })
  },

  async removeFiles (data = { attachment_path: '' }) {
    return axios.delete('shared/uploads/grower-documents/remove-all', { data })
  }

}

export default GrowerDocumentService
