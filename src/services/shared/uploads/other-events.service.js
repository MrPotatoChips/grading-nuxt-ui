...
const GrowerEventService = {
  ...
  async uploadFiles (params, useUploadProgress = null) {
    ...
    return axios.post('shared/uploads/other-events', params, finalConfig)
  },

  async removeFile (data = { attachment_path: '', file_name: '' }) {
    return axios.delete('shared/uploads/other-events/remove', { data })
  },

  async removeFiles (data = { attachment_path: '' }) {
    return axios.delete('shared/uploads/other-events/remove-all', { data })
  }
