...
const GrowerAttachmentService = {
  ...
  async uploadFiles (params, useUploadProgress = null) {
    ...
    return axios.post('shared/uploads/grower-attachments', params, finalConfig)
  },

  async removeFile (data = { attachment_path: '', file_name: '' }) {
    return axios.delete('shared/uploads/remove', { data })
  },

  async removeFiles (data = { attachment_path: '' }) {
    return axios.delete('shared/uploads/remove-all', { data })
  }

}

export default GrowerAttachmentService
